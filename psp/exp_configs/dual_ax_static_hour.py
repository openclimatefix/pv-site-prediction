...
PV_DATA_PATH = "/mnt/leonardo/storage_b/data/ocf/solar_pv_nowcasting/clients/uk_pv/15min_mid_v3.nc"
...
class ExpConfig(ExpConfigBase):
    ...
    def get_date_splits(self):
        return auto_date_split(
            test_start_date=dt.datetime(2021, 8, 8),
            test_end_date=dt.datetime(2021, 11, 8),
            num_trainings=1,
            train_days=356 * 2,
            min_train_date=dt.datetime(2020, 1, 10), #No ECMWF data before this date
            step_minutes=15,
        )
