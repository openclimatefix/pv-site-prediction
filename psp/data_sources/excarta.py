...
def _slice_on_lat_lon(
    ...
    *,
    ...
    if min_lat is not None:
        ...
        return data #TEMP HACK .sel(x=x, y=y, method="nearest")  # type: ignore

    return data


class ExcartaDataSource:
    """Wrapper around a zarr file containing the Excarta data.
    ...
    def __init__(
        ...
        *_dim_name: The 5 names of thedimensions in the data at `path`.
        ...
        cache_dir: If provided, the `at_get` function will cache its result in the directory. This
            ...
            Excarta is one of the main bottlenecks. Use with caution: it will create a lot of files!
    ...
    def _get(
        ...
        *,
        ...
        try:
            ...
            ds = ds.sel(
                init_time=now - dt.timedelta(minutes=self._lag_minutes),
                method="ffill",
        ...
        init_time = to_pydatetime(ds.init_time.values)
    ...
    def __getstate__(self):
        ...
        if self._paths is None:
            raise RuntimeError(
                "You can only pickle 'ExcartaDataSource`s that were constructed using paths"
            )
